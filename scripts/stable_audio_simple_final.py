...
支持 GPU 加速、内存优化、torch.compile 等特性
"""
import sys
import os
...
def main():
    parser = argparse.ArgumentParser(description="Stable Audio Open - GPU 优化版本")
    ...
    parser.add_argument("--num_steps", type=int, default=50, help="推理步数 (推荐 15-30)")
    ...
    parser.add_argument("--low_vram", action="store_true", help="启用低显存模式")
    ...
    try:
        ...
        wav_time = time.time() - wav_write_start
        ...
        print(json.dumps({
            ...
            "inference_time": inference_time - start_time,
            "wav_write_time": wav_time,
